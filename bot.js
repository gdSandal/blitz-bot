...
client.on('message', msg => {
 ...
 let args = msg.content.split(" ").slice(1)
 const wikilink = "http://jojo.wikia.com/wiki/List_of_Stands?file=" + args.join("") + "AvAnim.png";
 const googlelink = "https://www.google.com/search?q=" + args.join("+") + "&client=safari&hl=en";
